...
u32 CtrlRaceInputViewer::Count() {
    if(static_cast<Pulsar::WTPSettingInputDisplay>(Pulsar::Settings::Mgr::Get().GetUserSettingValue(static_cast<Pulsar::Settings::UserType>(Pulsar::Settings::SETTINGSTYPE_WTP), Pulsar::SETTINGWTP_INPUTVIEWER)) == Pulsar::WTPSETTING_INPUTDISPLAY_ENABLED) {
