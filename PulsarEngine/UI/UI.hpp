...
enum BMG {
    ...
    //Item Rain
    BMG_ITEMRAIN_TITLE_TEXT = 0x2858,
    BMG_ITEMRAIN_BUTTON = 0x2859,
    BMG_ITEMRAIN_WW_BOTTOM = 0x285a,

    //Shock
    BMG_SHOCK_TITLE_TEXT = 0x285b,
    BMG_SHOCK_BUTTON = 0x285c,
    BMG_SHOCK_WW_BOTTOM = 0x285d,
