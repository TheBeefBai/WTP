...
enum HostSettingUltras{
    HOSTSETTING_ULTRAS_ENABLED,
    HOSTSETTING_ULTRAS_DISABLED,
};
...
enum WTPSettingGamemode {
    ...
    WTPSETTING_GAMEMODE_FEATHERLESS,
    WTPSETTING_GAMEMODE_BOBOMBBLAST,
    WTPSETTING_GAMEMODE_SHOCKTILYOUDROP,
    WTPSETTING_GAMEMODE_ITEMRAIN,
};

enum WTPSettingWWMode{
    WWMODE_DEFAULT,
    WWMODE_200,
    WWMODE_OTT,
};
