...
SET ENGINE="C:\Users\sauxy\OneDrive\Documents\GitHub\WTP\KamekInclude"
set GAMESOURCE="C:\Users\sauxy\OneDrive\Documents\GitHub\WTP\GameSource"
SET PULSAR="C:\Users\sauxy\OneDrive\Documents\GitHub\WTP\PulsarEngine"
...
:: Link
echo Linking... %time%
"C:\Users\sauxy\OneDrive\Documents\GitHub\WTP\KamekLinker\Kamek.exe" "build/kamek.o" %OBJECTS% %debug% -dynamic -externals="%GAMESOURCE%/symbols.txt" -versions="%GAMESOURCE%/versions.txt" -output-combined=build\Code.pul
